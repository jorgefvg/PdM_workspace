...
void Gpio_Led_Write(gpio_state state);//Escritura, Al llamar la funcioo Led_Write y mando un HIGH enciendo o un LOW apaga
...
void Gpio_But_Init(void); //configuracion del boton

gpio_state Gpio_But_Read(void); //Configuracion de la lectura del boton
